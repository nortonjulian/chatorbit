...
const languages = [
  ...
  { code: 'ceb', name: 'Cebuano' }, { code: 'ny', name: 'Chichewa' }, { code: 'zh', name: 'Chinese' },
  ...
  { code: 'lb', name: 'Luxembourgish' }, { code: 'lt', name: 'Lithuanian' }, { code: 'mk', name: 'Macedonian' },
  ...
  { code: 'no', name: 'Norwegian' }, { code: 'pa', name: 'Punjabi' }, { code: 'ps', name: 'Pashto' },
  ...
  { code: 'gd', name: 'Scottish Gaelic' }, { code: 'sr', name: 'Serbian' }, { code: 'st', name: 'Sesotho' },
  ...
  { code: 'tr', name: 'Turkish' }, { code: 'ug', name: 'Uyghur' }, { code: 'uk', name: 'Ukrainian' },
