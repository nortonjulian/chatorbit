...
// Renamed from createEncryptedKeyBackup → createEncryptedChatBackup
export async function createEncryptedChatBackup({ unlockPasscode, backupPassword }) {
...
// Renamed from restoreEncryptedKeyBackup → restoreEncryptedChatBackup
export async function restoreEncryptedChatBackup({ file, backupPassword, setLocalPasscode }) {
