 ...
 */
export function addResourceToResponseData(response, telnyx, resourceName, methods) {
 ...
 */
export function createNestedMethods(telnyxMethod, names, spec) {
    const methods = {};
