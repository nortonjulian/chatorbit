...
var JSONBig = _interopDefault(require('json-bigint'));
...
function prepareArgs(params) {
  ...
  for (const paramName in params) {
    if (Object.prototype.hasOwnProperty.call(params, paramName)) {
      ...
      const validationResult = schema.validateAndUnmap(paramInfo[0], paramInfo[1]);
...
class DefaultRequestBuilder {
  ...
  xml(argName, data, rootName, schema$1) {
    const mappingResult = schema.validateAndUnmapXml(data, schema$1);
  ...
  async callAsJson(schema$1, requestOptions) {
    ...
    const mappingResult = schema.validateAndMap(parsed, schema$1);
    if (mappingResult.errors) {
  ...
  async callAsXml(rootName, schema$1, requestOptions) {
    this.interceptRequest(request => {
      const headers = {
        ...request.headers
      };
    ...
    const mappingResult = schema.validateAndMapXml(xmlObject, schema$1);
    if (mappingResult.errors) {
      throw new ResponseValidationError(result, mappingResult.errors);
    }
    return {
...
function getBaseUri(server = 'MessagingDefault', config) {
  ...
  if (config.environment === exports.Environment.Custom) {
    if (server === 'MessagingDefault') {
 ...
 * This file was automatically generated by APIMATIC v2.0 ( https://apimatic.io ).
 */
const bandwidthMessageSchema = /*#__PURE__*/schema.object({
  id: ['id', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.string())],
  owner: ['owner', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.string())],
  applicationId: ['applicationId', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.string())],
  time: ['time', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.string())],
  segmentCount: ['segmentCount', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.number())],
  direction: ['direction', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.string())],
  to: ['to', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.array( /*#__PURE__*/schema.string()))],
  from: ['from', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.string())],
  media: ['media', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.array( /*#__PURE__*/schema.string()))],
  text: ['text', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.string())],
  tag: ['tag', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.string())],
  priority: ['priority', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.string())]
});
 ...
 * This file was automatically generated by APIMATIC v2.0 ( https://apimatic.io ).
 */
const bandwidthMessageItemSchema = /*#__PURE__*/schema.object({
  messageId: ['messageId', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.string())],
  accountId: ['accountId', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.string())],
  sourceTn: ['sourceTn', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.string())],
  destinationTn: ['destinationTn', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.string())],
  messageStatus: ['messageStatus', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.string())],
  messageDirection: ['messageDirection', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.string())],
  messageType: ['messageType', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.string())],
  segmentCount: ['segmentCount', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.number())],
  errorCode: ['errorCode', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.number())],
  receiveTime: ['receiveTime', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.string())],
  carrierName: ['carrierName', /*#__PURE__*/schema.nullable( /*#__PURE__*/schema.optional( /*#__PURE__*/schema.string()))]
});
 ...
 * This file was automatically generated by APIMATIC v2.0 ( https://apimatic.io ).
 */
const pageInfoSchema = /*#__PURE__*/schema.object({
  prevPage: ['prevPage', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.string())],
  nextPage: ['nextPage', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.string())],
  prevPageToken: ['prevPageToken', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.string())],
  nextPageToken: ['nextPageToken', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.string())]
});
 ...
 * This file was automatically generated by APIMATIC v2.0 ( https://apimatic.io ).
 */
const bandwidthMessagesListSchema = /*#__PURE__*/schema.object({
  totalCount: ['totalCount', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.number())],
  pageInfo: ['pageInfo', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.lazy(() => pageInfoSchema))],
  messages: ['messages', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.array( /*#__PURE__*/schema.lazy(() => bandwidthMessageItemSchema)))]
});
 ...
 * This file was automatically generated by APIMATIC v2.0 ( https://apimatic.io ).
 */
const mediaSchema = /*#__PURE__*/schema.object({
  content: ['content', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.string())],
  contentLength: ['contentLength', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.number())],
  mediaName: ['mediaName', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.string())]
});
...
})(exports.PriorityEnum || (exports.PriorityEnum = {}));
/**
 * Schema for PriorityEnum
 */
const priorityEnumSchema = /*#__PURE__*/schema.stringEnum(exports.PriorityEnum);
 ...
 * This file was automatically generated by APIMATIC v2.0 ( https://apimatic.io ).
 */
const messageRequestSchema = /*#__PURE__*/schema.object({
  applicationId: ['applicationId', /*#__PURE__*/schema.string()],
  to: ['to', /*#__PURE__*/schema.array( /*#__PURE__*/schema.string())],
  from: ['from', /*#__PURE__*/schema.string()],
  text: ['text', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.string())],
  media: ['media', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.array( /*#__PURE__*/schema.string()))],
  tag: ['tag', /*#__PURE__*/schema.optional( /*#__PURE__*/schema.string())],
  priority: ['priority', /*#__PURE__*/schema.optional(priorityEnumSchema)]
});
...
class ApiController extends BaseController {
  ...
  async listMedia(accountId, continuationToken, requestOptions) {
    ...
    const mapped = req.prepareArgs({
      ...
      continuationToken: [continuationToken, schema.optional(schema.string())]
    });
    ...
    return req.callAsJson(schema.array(mediaSchema), requestOptions);
  }
  /**
   * getMedia
   *
  ...
  async uploadMedia(accountId, mediaId, body, contentType, cacheControl, requestOptions) {
    ...
    const mapped = req.prepareArgs({
      accountId: [accountId, schema.string()],
      mediaId: [mediaId, schema.string()],
      contentType: [contentType, schema.optional(schema.string())],
      cacheControl: [cacheControl, schema.optional(schema.string())]
    });
  ...
  async getMessages(accountId, messageId, sourceTn, destinationTn, messageStatus, errorCode, fromDateTime, toDateTime, pageToken, limit, requestOptions) {
    ...
    const mapped = req.prepareArgs({
      accountId: [accountId, schema.string()],
      messageId: [messageId, schema.optional(schema.string())],
      sourceTn: [sourceTn, schema.optional(schema.string())],
      destinationTn: [destinationTn, schema.optional(schema.string())],
      messageStatus: [messageStatus, schema.optional(schema.string())],
      errorCode: [errorCode, schema.optional(schema.number())],
      fromDateTime: [fromDateTime, schema.optional(schema.string())],
      toDateTime: [toDateTime, schema.optional(schema.string())],
      pageToken: [pageToken, schema.optional(schema.string())],
...
//# sourceMappingURL=messaging.cjs.development.js.map
