 ...
 */
export declare function setHeader(headers: Record<string, string | number | boolean>, name: string, value?: string | number | boolean | undefined): void;
/**
 ...
 * @param value Header value
 */
export declare function setHeaderIfNotSet(headers: Record<string, string | number | boolean>, name: string, value?: string | number | boolean | undefined): void;
/**
 ...
 */
export declare function mergeHeaders(headers: Record<string, string | number | boolean>, headersToMerge: Record<string, string | number | boolean>): void;
/**
