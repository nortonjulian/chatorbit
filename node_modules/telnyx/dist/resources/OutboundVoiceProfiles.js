...
exports.OutboundVoiceProfiles = void 0;
...
function transformResponseData(response, telnyx) {
    return utils.addResourceToResponseData(response, telnyx, 'outboundVoiceProfiles', {
        del: telnyxMethod({
            method: 'DELETE',
            path: '/{outboundId}',
...
exports.OutboundVoiceProfiles = TelnyxResource_js_1.default.extend({
