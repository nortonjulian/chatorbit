...
exports.NumberReservations = void 0;
...
exports.NumberReservations = TelnyxResource_js_1.default.extend({
    path: 'number_reservations',
    includeBasic: ['list', 'retrieve'],
    create: telnyxMethod({
        method: 'POST',
        transformResponseData: function (response, telnyx) {
            return utils.addResourceToResponseData(response, telnyx, 'numberReservations', {
                extend: telnyxMethod({
                    method: 'POST',
